...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#F9F5F6] cursor-pointer" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          ...
          <div className="flex flex-col">
            <h4 className="font-epilogue font-semibold text-[14px] text-[#b2b3bd] leading-[22px]">{remainingDays[0]}</h4>
            <p className="mt-[3px] font-epilogue font-normal text-[12px] leading-[18px] text-[#808191] sm:max-w-[120px] truncate">{remainingDays[1]} Left</p>
          </div>
        </div>
