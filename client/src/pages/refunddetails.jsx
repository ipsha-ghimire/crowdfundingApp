...
const RefundDetails = () => {
  ...
  const {  getDonations, contract, address, refund,getRefundStatus } = useStateContext();
  ...
  const fetchDonatedAmount = async () => {
    ...
    console.log('Refund Status 2:', refundStatus); // Log the value of status
        ...
        <div className="flex-1">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#F3F1F1] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              <CustomButton 
                btnType="button"
                title={refundStatus? 'Refund Closed' : 'Ask Refund'}
                styles={`w-full bg-[#1dc071] ${refundStatus? 'opacity-50 cursor-not-allowed' : ''}`}
